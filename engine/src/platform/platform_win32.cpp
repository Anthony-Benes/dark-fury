...
b8 platform_startup(platform_state* plat_state, const char* application_name, i32 x, i32 y,
    ...
    HWND handle =
      CreateWindowExA(window_ex_style, "dark_fury_window_class", application_name, window_style,
...
void* platform_zero_memory(void* block, u64 size) {
    return memset(block, 0, static_cast<size_t>(size));
}

void* platform_copy_memory(void* dest, const void* source, u64 size) {
    return memcpy(dest, source, static_cast<size_t>(size));
}

void* platform_set_memory(void* dest, i32 value, u64 size) {
    return memset(dest, value, static_cast<size_t>(size));
}
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    switch ( msg ) {
        ...
        case WM_RBUTTONUP:   {
            ...
            switch ( msg ) {
                case WM_LBUTTONDOWN:
                case WM_LBUTTONUP:   button = Engine::Input::Buttons::M_Left; break;
                case WM_MBUTTONDOWN:
                case WM_MBUTTONUP:   button = Engine::Input::Buttons::M_Middle; break;
                case WM_RBUTTONDOWN:
                case WM_RBUTTONUP:   button = Engine::Input::Buttons::M_Right; break;
            }
